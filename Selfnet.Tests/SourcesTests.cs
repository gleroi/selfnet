...
namespace Selfnet.Tests
{
    public class SourcesTests
    {
        ...
        {
            Context.Http.ServerReturns(@"[{""id"":""33"",""title"":"".NET Curry: Recent Articles"",""tags"":"""",""spout"":""spouts\\rss\\feed"",""params"":{""url"":""http://feeds.feedburner.com/netCurryRecentArticles""},""filter"":null,""error"":"""",""icon"":""a39473e4e64f4ef8cba7ea8b87fea3f8.png""},
        ...
        {
            Context.Http.ServerReturns("{ 'success': true, 'id': 25 }");
            var api = Context.Api();
        ...
        [Fact]
        public async void Sources_Delete_ShouldWork()
        {
            Context.Http.ServerReturns("{ 'success': true }");

            var api = Context.Api();

            var result = await api.Sources.Delete(73);
        ...
        {
            Context.Http.ServerReturns(@"[{""id"":""33"",""title"":"".NET Curry: Recent Articles"",""unread"":""0""},
        ...
        {
            Context.Http.ServerReturns(@"{""spouts\\deviantart\\dailydeviations"":{""name"":""deviantART - daily deviations"",""description"":""daily deviations of deviantART"",""params"":false},
